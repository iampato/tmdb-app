...
class _$_Success implements _Success {
  ...
  @override
  String toString() {
    return 'TopRatedMoviesState.success(moviesModel: $moviesModel, doneFetchingMore: $doneFetchingMore, page: $page, message: $message)';
  }
...
abstract class _Success implements TopRatedMoviesState {
...
abstract class _Error implements TopRatedMoviesState {
