...
_$_SingleMovieDto _$$_SingleMovieDtoFromJson(Map<String, dynamic> json) =>
    _$_SingleMovieDto(
...
Map<String, dynamic> _$$_SingleMovieDtoToJson(_$_SingleMovieDto instance) =>
    <String, dynamic>{
